...
The detrended hierarchy result strengthens that warning: even oracle coarse routing barely improves exact subject-fold accuracy. Future hierarchical work should focus on pair-specific representations or calibration, not only on better coarse routing.
